...
@section('title', 'All Bookings | KELA Venue Owner')
@section('content')
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">                  
                <div class="row align-items-center my-4">
                    ...
                    <div class="col-auto">
                    <a href="{{route('venue.booking.exportxlsx')}}" class="btn btn-dark" style="color:white">
                        <span style="color:white"></span> {{ __('Export as XLSX') }}
                    </a>
                    <a href="{{route('venue.booking.exportcsv')}}" class="btn btn-dark" style="color:white">
                        <span style="color:white"></span> {{ __('Export as CSV') }}
                    </a>
                    <a href="{{route('venue.booking.create')}}" class="btn btn-danger" style="color:white">
                                            ...
                                            <tbody>
                                                <tr class="text-center">
                                                    ...
                                                    <td style="width: 250px">
                                                            <a class="btn btn-primary mb-2" href="{{ route('venuedashboard.booking.edit',$booking->id) }}"><i class='bx bx-edit' ></i> {{ __('Edit') }}</a>
                                                            <a class="btn btn-info mb-2" href="{{ route('venuedashboard.booking.receipt',$booking->id) }}"><i class='bx bx-receipt'></i> {{ __('Receipt') }}</a>
                                                            {!! Form::open(['method' => 'DELETE','route' => ['venuedashboard.booking.destroy', $booking->id],'style'=>'display:inline']) !!}
