...
@section('title', 'Dashboard | KELA Venue Owner')
                                    ...
                                    <div class="card-body card-counter card1">
                                        <div class="row">
                                            ...
                                            <div class="col text-right my-auto">
                                                ...
                                                <h4 class="card-title font-weight-bold">Venues</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body card-counter card4">
                                        <div class="row">
                                            ...
                                            <div class="col text-right my-auto">
                                                ...
                                                <h4 class="card-title font-weight-bold">Booking</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body card-counter card5">
                                        <div class="row">
                                            ...
                                            <div class="col text-right my-auto">
                                                ...
                                                <h4 class="card-title font-weight-bold">Timeslots</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <table class="table text-center">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td><a style="text-decoration: none; color: black;" href="{{ route('venuedashboard.booking.edit',$booking->id) }}">{{ $booking->venue->name }}</a></td>
                                    <td><a style="text-decoration: none; color: black;" href="{{ route('venuedashboard.booking.edit',$booking->id) }}">{{ $booking->timeslot->starttime }} - {{ $booking->timeslot->endtime }}</a></td>
                            ...
                            <table class="table text-center">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <th><a style="text-decoration: none; color: black;" href="{{ route('venuedashboard.venues.edit',$venue->id) }}">{{ $venue->name }}</a></th>
                            ...
                            <table class="table text-center">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <th><a style="text-decoration: none; color: black;" href="{{ route('venuedashboard.timeslots.edit',$timeslot->id) }}">{{ $timeslot->starttime }} - {{ $timeslot->endtime }}</a></th>
