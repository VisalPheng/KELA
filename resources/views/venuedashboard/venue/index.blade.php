...
@section('title', 'All Venues | KELA Venue Owner')
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="row align-items-center my-4">
                ...
                <div class="col-auto">
                    <a href="{{route('venuedashboard.venues.create')}}" class="btn btn-success" style="color:white">
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <a class="btn btn-primary mb-2"
                                                href="{{ route('venuedashboard.venues.edit',$venue->id) }}"><i class='bx bx-edit' ></i> Edit</a>
                                            <a class="btn btn-info mb-2"
                                                href="{{ route('venuedashboard.venues.show',$venue->id) }}"><i class='bx bx-photo-album' ></i> Photos</a>
                                            {!! Form::open(['method' => 'DELETE','route' =>
                                            ['venuedashboard.venues.destroy', $venue->id],'style'=>'display:inline'])
                                            !!}
