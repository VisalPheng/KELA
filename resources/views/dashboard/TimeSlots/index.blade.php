...
@section('title', 'All Time Slots | KELA Administrator')
@section('content')
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">                  
                <div class="row align-items-center my-4">
                    ...
                    <div class="col-auto">
                            <a href="{{route('admin.timeslots.create')}}" class="btn btn-danger" style="color:white">
                                        ...
                                        @foreach ($alltimeslots as $timeslot)
                                            <tbody>
                                                <tr class="text-center">
                                                    ...
                                                    <td>
                                                            <a class="btn btn-primary mb-2" href="{{ route('admin.timeslots.edit',$timeslot->id) }}"><i class='bx bx-edit' ></i> {{ __('Edit') }}</a>
                                                            {!! Form::open(['method' => 'DELETE','route' => ['admin.timeslots.destroy', $timeslot->id],'style'=>'display:inline']) !!}
