...
@section('title', 'Edit F.A.Q | KELA Administrator')
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="row align-items-center my-4">
                <div class="col">
                    <h2 class="h3 mb-0 page-title">{{ __('Edit F.A.Q') }}</h2>
                </div>
                <div class="col-auto">
                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin.faqs.index')}}">{{
                                        __('F.A.Qs') }}</a></li>
                                <li class="breadcrumb-item active">{{ __('Edit F.A.Q') }}</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.faqs.update',$faq->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="desc-editor" rows="5" name="description" class="form-control">{{$faq->description}}</textarea>
                        </div>

                        <div class="form-group">
                        <label>Approval</label>
                            <select name="approve" class="form-control selectpicker" data-style="btn-danger">
                                <option value="1" @if($faq->status==1)selected @endif>Approve</option>
                                <option value="2" @if($faq->status==2)selected @endif>Reject</option>
                            </select>
                        </div>
