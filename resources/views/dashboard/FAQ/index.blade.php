...
@section('title', 'All F.A.Qs | KELA Administrator')
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="row align-items-center my-4">
                <div class="col">
                    <h2 class="h3 mb-0 page-title">{{ __('F.A.Qs') }}</h2>
                </div>
                <div class="col-auto">
                    <a href="{{route('admin.faqs.create')}}" class="btn btn-danger" style="color:white">
                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{
                                        __('Dashboard') }}</a></li>
                                <li class="breadcrumb-item active">{{ __('F.A.Qs') }}</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <a class="btn btn-primary mb-2"
                                                href="{{ route('admin.faqs.edit',$item->id) }}"><i class='bx bx-edit' ></i> Edit</a>
                                            {!! Form::open(['method' => 'DELETE','route' =>
                                            ['admin.faqs.destroy', $item->id],'style'=>'display:inline'])
                                            !!}
