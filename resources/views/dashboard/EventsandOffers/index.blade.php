...
@section('title', 'All Events and Offers | KELA Administrator')
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="row align-items-center my-4">
                <div class="col">
                    <h2 class="h3 mb-0 page-title">{{ __('Events and Offers') }}</h2>
                </div>
                <div class="col-auto">
                    <a href="{{route('admin.eventsandoffers.create')}}" class="btn btn-danger" style="color:white">
                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{
                                        __('Dashboard') }}</a></li>
                                <li class="breadcrumb-item active">{{ __('Events and Offers') }}</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card shadow">
                        <div class="card-body">
                            ...
                            <table class="table datatables" id="dataTable-1">
                                ...
                                @foreach ($eventsandoffers as $item)
                                <tbody>
                                    <tr class="text-center">
                                        <td>{{ $item->id }}</td>
                                        <td>
                                        ...
                                        <td>{{ $item->name }}</td>
                                        <td>{!!Str::limit($item->description, 350, ' (...)')!!}</td>
                                        <td>
                                            @if($item->status == 0)
                                        ...
                                        <td>
                                            <a class="btn btn-primary mb-2"
                                                href="{{ route('admin.eventsandoffers.edit',$item->id) }}"><i class='bx bx-edit' ></i> Edit</a>
                                            {!! Form::open(['method' => 'DELETE','route' =>
                                            ['admin.eventsandoffers.destroy', $item->id],'style'=>'display:inline'])
                                            !!}
                            ...
                            @endif
                            <div class="d-flex justify-content-center">
                                {!! $eventsandoffers->links("pagination::bootstrap-4") !!}
                            </div>
                            <!-- end table -->
                        </div>
                    </div>
